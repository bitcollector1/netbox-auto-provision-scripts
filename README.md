...
###### Script must have a "Base" system in place. If you used the seed script you will also have IP's added to /etc/host file so no DNS is needed for SSH to work
